...
# 定义数据集相关的变量
dataset_file_list = ["green_tripdata_2021-01.csv", "green_tripdata_2021-02.csv","green_tripdata_2021-03.csv","green_tripdata_2021-04.csv","green_tripdata_2021-05.csv"]            # 数据集文件名
