...
dataset_file_list = ["green_tripdata_2021-01.csv","green_tripdata_2021-02.csv","green_tripdata_2021-03.csv","green_tripdata_2021-04.csv","green_tripdata_2021-05.csv","green_tripdata_2021-06.csv"]            # 数据集文件名
...
# 使用上下文管理器创建DAG
with DAG(
    dag_id="data_ingestion_gcs_dag_green_trip",    
